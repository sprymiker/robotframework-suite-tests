...
Yves: go to '${pageName}' page through the header   
    Run Keyword If    '${pageName}' == 'Shopping Lists'    Yves: go To 'Shopping Lists' Page
    ...    ELSE IF    '${pageName}' == 'Shopping Carts'    Yves: Go to 'Shopping Carts' page
    ...    ELSE IF    '${pageName}' == 'Quick Order'    Yves: Go to 'Quick Order' page
    ...    ELSE IF    '${pageName}' == 'Quote Requests'    Yves: Go to 'Quote Requests' page
    ...    ELSE IF    '${pageName}' == 'Wishlist'    Yves: go To 'Wishlist' Page
...
Yves: go to user menu item in header:
    ...
    Run keyword if    '${env}'=='b2b'    Click    //li[contains(@class,'user-navigation__item--user')]//nav[contains(@class,'user-navigation__sub-nav')]//ul[contains(@class,'list--secondary')]//a[text()='${user_menu_item}']
    ...    ELSE    Click    //a[contains(@class,'user-block') and contains(text(),'${user_menu_item}')]
