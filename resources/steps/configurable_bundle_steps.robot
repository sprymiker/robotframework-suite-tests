...
Yves: select product in the bundle slot:
    ...
    ...    ELSE    Run keyword if    '${env}' in ['b2c','mp_b2c']    Click    xpath=(//product-item-list[@data-qa='component configurator-product']//span[contains(text(),'${sku}')]/ancestor::product-item-list//button)[1]
