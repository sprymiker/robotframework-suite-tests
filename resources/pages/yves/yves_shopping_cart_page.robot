*** Variables ***
${shopping_cart_main_content_locator}    xpath=//*[@class='page-layout-cart']
...
${shopping_cart_promotional_product_increase_quantity_button}    xpath=//product-item[contains(@data-qa,'component product-item')]//quantity-counter//div[contains(@class,'button button--quantity js-quantity-counter__incr')]
${shopping_cart_promotional_product_decrease_quantity_button}    xpath=//product-item[contains(@data-qa,'component product-item')]//quantity-counter//div[contains(@class,'button button--quantity js-quantity-counter__decr')]
