...
&{customer_account_add_new_address_button}     b2c=xpath=//a[@data-qa='customer-add-new-address']    b2b=xpath=//a[contains(@href,'address/new')]    mp_b2c=xpath=//a[@data-qa='customer-add-new-address']