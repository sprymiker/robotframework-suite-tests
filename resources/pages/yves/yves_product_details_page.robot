*** Variable ***
${pdp_main_container_locator}    xpath=//*[@itemtype='https://schema.org/Product']//product-carousel[contains(@*, 'pdp')]
...
${pdp_quantity_input_filed}    xpath=//*[@data-qa='quantity-input']
${pdp_alternative_products_slider}    xpath=//*[contains(@class,'product-slider')][contains(.,'Alternative products')]/../slick-carousel
...
${pdp_product_bundle_include_small}    path=//ul[@class='bundle-option-list grid']
${pdp_product_bundle_include_large}    xpath=//div[@data-qa='component product-bundle']
${pdp_related_products}    xpath=//*[contains(@class,'product-slider')][contains(.,'You might also like')]/../slick-carousel
${pdp_add_to_shopping_list_button}    xpath=//button[@data-qa='add-to-shopping-list-button']
${pdp_product_sku}    xpath=//section[@class='product-detail']//div[@class='spacing-top spacing-top--bigger']
${pdp_shopping_list_selector}    xpath=//form[contains(@action,'shopping-list')]//select
${pdp_sales_label}    xpath=//product-carousel//*[@data-qa='component label-group']//span[contains(text(),'SALE')]
${pdp_new_label}    xpath=//product-carousel//*[@data-qa='component label-group']//span[contains(text(),'New')]
