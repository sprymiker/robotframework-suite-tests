...
&{checkout_address_delivery_dropdown}    b2b=xpath=//span[@id='select2-checkout-full-addresses-ct-container']    b2c=xpath=//span[@id='select2-addressesForm_shippingAddress_id_customer_address-container']    mp_b2c=xpath=//span[@id='select2-addressesForm_shippingAddress_id_customer_address-container']
&{checkout_address_delivery_selector}    b2c=xpath=//select[@id='addressesForm_shippingAddress_id_customer_address']    b2b=xpath=//div[contains(@class,'shippingAddress')]//select[@name='checkout-full-addresses'][contains(@class,'address__form')]    mp_b2c=xpath=//select[@id='addressesForm_shippingAddress_id_customer_address']
...
&{checkout_shipping_address_first_name_field}    b2b=id=checkout_shipping_address_first_name_field    b2c=id=addressesForm_shippingAddress_first_name    mp_b2c=id=addressesForm_shippingAddress_first_name
...
&{checkout_address_billing_selector}    b2c=xpath=//select[@id='addressesForm_billingAddress_id_customer_address']    b2b=xpath=//select[contains(@class,'form-select-billingAddress')]    mp_b2c=xpath=//select[@id='addressesForm_billingAddress_id_customer_address']
