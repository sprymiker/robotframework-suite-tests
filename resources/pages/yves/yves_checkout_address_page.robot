...
${checkout_address_delivery_dropdown}    xpath=//span[@id='select2-addressesForm_shippingAddress_id_customer_address-container']
${checkout_address_delivery_selector}    xpath=//select[@id='addressesForm_shippingAddress_id_customer_address']
...
${checkout_address_billing_selector}    xpath=//select[@id='addressesForm_billingAddress_id_customer_address']
