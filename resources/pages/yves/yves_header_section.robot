...
${user_navigation_icon_header_menu_item}   xpath=//nav[@data-qa='component navigation-top']//*[@*='user-account']
${user_navigation_fly_out_header_menu_item}    xpath=//div[contains(@class,'user-block js-nav-overlay__drop-down-block')]
...
${currency_switcher_header_menu_item}    xpath=//div[@class='header__select']//select[@name='currency-iso-code']
...
${shopping_car_icon_header_menu_item}    xpath=//cart-counter[contains(@class,'navigation-top')]
