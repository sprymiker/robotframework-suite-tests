...
&{user_navigation_icon_header_menu_item}    b2b=xpath=//div[contains(@class,'user-navigation__user-name')]    b2c=xpath=//nav[@data-qa='component navigation-top']//*[@*='user-account']    mp_b2c=xpath=//nav[@data-qa='component navigation-top']//*[@*='user-account']
&{user_navigation_fly_out_header_menu_item}    b2b=xpath=//li[contains(@class,'user-navigation__item--user')]//nav[contains(@class,'user-navigation__sub-nav')]//ul[contains(@class,'list--secondary')]    b2c=xpath=//div[contains(@class,'user-block js-nav-overlay__drop-down-block')]    mp_b2c=xpath=//div[contains(@class,'user-block js-nav-overlay__drop-down-block')]
...
&{currency_switcher_header_menu_item}    b2b=xpath=//*[@data-qa='component navigation-top']//select[@name='currency-iso-code']    b2c=xpath=//div[@class='header__select']//select[@name='currency-iso-code']    mp_b2c=xpath=//div[@class='header__select']//select[@name='currency-iso-code']
...
&{shopping_car_icon_header_menu_item}    b2b=xpath=//*[contains(@class,'icon--cart')]/ancestor::a    b2c=xpath=//cart-counter[contains(@class,'navigation-top')]    mp_b2c=xpath=//cart-counter[contains(@class,'navigation-top')]
