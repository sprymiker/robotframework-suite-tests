...
# Catalog_Actions
#     [Documentation]    Checks product groups
...
#     Yves: add product to the shopping cart
#     Yves: go to b2c shopping cart
#     Yves: shopping cart contains the following products:    Canon IXUS 160
#     [Teardown]    Yves: check if cart is not empty and clear it
...
#     Yves: go to PDP of the product with sku:    205
...
#     Yves: PDP contains/doesn't contain:    true    ${pdpPriceLocator}   ${addToCartButton}    ${pdp_gift_wrapping_option}    ${relatedProducts}
#     Yves: PDP contains/doesn't contain:    false    ${pdp_add_to_wishlist_button}
#     Yves: login on Yves with provided credentials:    ${yves_user_email}
#     Yves: go to PDP of the product with sku:    135
#     Yves: PDP contains/doesn't contain:    true    ${pdpPriceLocator}   ${pdp_add_to_cart_disabled_button}[${env}]    ${pdp_gift_wrapping_option}     ${pdp_add_to_wishlist_button}    ${relatedProducts}
#     Yves: change variant of the product on PDP on:    Flash
#     Yves: PDP contains/doesn't contain:    true    ${pdpPriceLocator}    ${addToCartButton}    ${pdp_gift_wrapping_option}     ${pdp_add_to_wishlist_button}    ${relatedProducts}
...
# Product_Sets
# #NOTE: not supported by Marketplace
